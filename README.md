...
Optimizations: non debug 1000HZ timer kernel, schedutil cpu governor, migitations are disabled, limited set of device drivers, latest gpu drivers, Xfce desktop and the installer media is 626 MBytes. 
